...
<div class="hero-text">
<h1>Soins esthétiques pour votre véhicule, directement chez
 vous.</h1>
<p class="hero-subtitle">Nettoyage intérieur complet, rénov
ation de phares et lustrage carrosserie par un professionne
l expérimenté sur Marseille.</p>

<p>
  Fort de plus de 20 ans d’expérience en carrosserie-peintu
re, je mets mon expertise au service de votre véhicule.
</p>

<p>
  Aujourd’hui, je mets cette expertise au service des parti
culiers et professionnels pour&nbsp;:
</p>

<ul>
  <li><strong>Nettoyage intérieur complet</strong> de votre
 véhicule</li>
  <li><strong>Détachage sièges &amp; moquettes</strong></li
>
  <li><strong>Rénovation de phares opaques / jaunis</strong
></li>
  <li><strong>Lustrage léger et remise en beauté carrosseri
e</strong></li>
</ul>

<p>
  J’interviens <strong>à domicile ou sur votre lieu de trav
ail</strong> sur Marseille et alentours.
</p>

<a
  href="https://wa.me/33614031995?text=Bonjour%20Fabrice,%2
0j’aimerais%20un%20devis%20pour%20mon%20véhicule.%0A%0A-%20
Modèle%20:%0A-%20Prestation%20souhaitée%20:%0A-%20Ville%20:
%0A"
...
{{< titre level="2" text="Mes prestations principales" align="center" color="accent" decoration="underline" >}}
...
<section class="fade-in-section">
{{< titre level="2" text="Pourquoi me confier votre véhicule ?" align="center" color="dark" decoration="highlight" >}}

<h3>20+ ans d’expérience en carrosserie-peinture</h3>

<p>
  J’ai travaillé plus de 20 ans chez <strong>Renault</stron
g>, en atelier carrosserie-peinture et réception clientèle.
  Cette expérience me permet de&nbsp;:
</p>
...
<section class="fade-in-section">
{{< titre level="2" text="Déroulement d'une intervention" align="center" color="accent" decoration="gradient" >}}
...
<ol>
  <li>
    ...
    Par WhatsApp, téléphone ou formulaire de contact.<br />
    Vous m’indiquez le modèle du véhicule, la prestation so
uhaitée et, si possible, des photos.
  </li>
  <li>
    <strong>Devis et prise de rendez-vous</strong><br />
    Je vous propose un devis adapté.<br />
    Nous fixons ensemble un créneau d’intervention.
  </li>
  <li>
    <strong>Intervention sur place</strong><br />
    J’arrive avec le matériel nécessaire, je protège les zo
nes sensibles et je réalise la prestation
    dans le temps prévu.
  </li>
  <li>
    <strong>Contrôle et conseils</strong><br />
    Vérification du résultat avec vous et conseils pour ent
retenir l’intérieur et l’extérieur du véhicule.
  </li>
</ol>
...
<section class="fade-in-section">
{{< titre level="2" text="Zone d'intervention" align="center" color="accent" decoration="border" >}}

<p>Je suis basé à <strong>Marseille</strong> et j’intervien
s principalement sur&nbsp;:</p>

<ul>
  <li>Marseille et proche périphérie</li>
  <li>Possibilité d’intervenir plus loin selon le devis (à
discuter)</li>
</ul>

<p>N’hésitez pas à me contacter pour vérifier si votre sect
eur est couvert.</p>
</section>
...
<p>Dès que les premiers avis seront disponibles, je les aff
icherai ici.</p>
</section>
